...
| Plugin | Description |
|--------|-------------|
| [deepclaude](plugins/deepclaude/) | Packaged [DeepClaude](https://github.com/aattaran/deepclaude) launcher and proxy for DeepSeek/OpenRouter/Fireworks with live backend switching |
